...
VAD_MODE = 1  # Changed to a less aggressive mode for better background noise filtering
...
def detect_movement():
    ...
    try:
        ...
        print(f"Error (detect_movement - visual processing): {e}")
...
if __name__ == '__main__':
    audio_thread = threading.Thread(target=audio_monitoring_thread, args=(audio_event_queue,))
